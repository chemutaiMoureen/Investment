...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('view', 'View'), ('crud', 'CRUD'), ('post', 'Post Only')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(through='investment_app.AccountMembership', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='accountmembership',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='investment_app.investmentaccount'),
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
